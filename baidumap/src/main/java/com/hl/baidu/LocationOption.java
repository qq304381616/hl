package com.hl.baidu;

import com.baidu.location.LocationClientOption;
import com.baidu.location.LocationClientOption.LocationMode;
import com.hl.baidu.service.LocationService;
import com.hl.baidu.service.Utils;
...
public class LocationOption extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locService = Utils.locationService;
    ...
    protected void onResume() {
        ...
        startLoc.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                int i1 = selectLocMode.getCheckedRadioButtonId();
                if (i1 == R.id.radio_hight) {
                    option.setLocationMode(LocationMode.Hight_Accuracy);

                } else if (i1 == R.id.radio_low) {
                    option.setLocationMode(LocationMode.Battery_Saving);

                } else if (i1 == R.id.radio_device) {
                    option.setLocationMode(LocationMode.Device_Sensors);

                }
                int i = selectcoord.getCheckedRadioButtonId();
                if (i == R.id.radio_gcj02) {
                    option.setCoorType(Utils.CoorType_GCJ02);

                } else if (i == R.id.radio_bd09ll) {
