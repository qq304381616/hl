...
public class Utils {
    ...
    public static void init(Context c) {
        locationService = new LocationService(c.getApplicationContext());
        mVibrator = (Vibrator) c.getApplicationContext().getSystemService(Service.VIBRATOR_SERVICE);
