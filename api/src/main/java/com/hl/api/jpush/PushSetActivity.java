...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.bt_alias) {
            setAlias();

        } else if (i == R.id.setStyle0) {
            setAddActionsStyle();
    ...
    private void setStyleBasic() {
        ...
        builder.statusBarDrawable = R.drawable.jpush_ic_launcher;
    ...
    private void setStyleCustom() {
        ...
        builder.layoutIconDrawable = R.drawable.jpush_ic_launcher;
