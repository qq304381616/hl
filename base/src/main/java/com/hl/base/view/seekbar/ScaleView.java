package com.hl.base.view.seekbar;
...
//            drawBorder(canvas);
    ...
    private void drawScaleMark(Canvas canvas) {
        ...
        while (true) {
            ...
            if (leftNum % (5 * scaleNum) == 0) {
                mScaleMarkPaint.setColor(0xffff0000);
                canvas.drawLine(left, 10, left, canvas.getHeight() - 10, mScaleMarkPaint);
                mScaleMarkPaint.getTextBounds(leftText, 0, leftText.length(), mTextRect);
            } else
                mScaleMarkPaint.setColor(0xff979797);
            canvas.drawLine(left, canvas.getHeight() / 3, left, canvas.getHeight() / 3 * 2, mScaleMarkPaint);

            if (rightNum % (5 * scaleNum) == 0) {
                mScaleMarkPaint.setColor(0xffff0000);
                canvas.drawLine(right, 10, right, canvas.getHeight() - 10, mScaleMarkPaint);
                mScaleMarkPaint.getTextBounds(rightText, 0, rightText.length(), mTextRect);
            } else
                mScaleMarkPaint.setColor(0xff979797);
            canvas.drawLine(right, canvas.getHeight() / 3, right, canvas.getHeight() / 3 * 2, mScaleMarkPaint);
    ...
    private void drawMarkPoint(Canvas canvas) {
        ...
        canvas.drawLine(centerX, 0, centerX, 5, mCurrentMarkPaint);
        canvas.drawLine(centerX, canvas.getHeight() - 5, centerX, canvas.getHeight(), mCurrentMarkPaint);
    }
