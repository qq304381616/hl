...
public class AndroidMapActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sb.append("LongSparseArray<String> == List<Long, String>" + "\n");
        sb.append("SparseLongArray == List<Integer, Long>" + "\n");
        sb.append("SparseArray<String> == List<Long, String>" + "\n");
        sb.append("SparseIntArray == List<Integer, Integer>" + "\n");
        sb.append("SparseLongArray == List<Integer, Long>" + "\n");
        sb.append("SparseBooleanArray == List<Integer, Boolean>" + "\n");
