...
public class MovieView extends RelativeLayout {
    ...
    public MovieView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray attributes =
                context.obtainStyledAttributes(
                        attrs,
                        R.styleable.ViewMovieView,
                        defStyleAttr,
                        R.style.Widget_PictureInPicture_MovieView);
        setVideoResourceId(attributes.getResourceId(R.styleable.ViewMovieView_android_src, 0));
        setAdjustViewBounds(
                attributes.getBoolean(R.styleable.ViewMovieView_android_adjustViewBounds, false));
        setTitle(attributes.getString(R.styleable.ViewMovieView_android_title));
        attributes.recycle();
        ...
        final OnClickListener listener =
                new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        } else if (i == R.id.toggle) {
                            toggle();

                        } else if (i == R.id.fast_forward) {
                            fastForward();

                        } else if (i == R.id.fast_rewind) {
                            fastRewind();
    ...
    void adjustToggleState() {
        if (mMediaPlayer != null && mMediaPlayer.isPlaying()) {
            ...
            mToggle.setImageResource(R.drawable.view_pause_64dp);
        } else {
            mToggle.setContentDescription(getResources().getString(R.string.play));
            mToggle.setImageResource(R.drawable.view_play_arrow_64dp);
        }
    }
