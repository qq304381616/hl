...
public class PipActivity extends BaseActivity {
            ...
            new MovieView.MovieListener() {
                ...
                public void onMovieStarted() {
                    ...
                    updatePictureInPictureActions(
                            R.drawable.view_pause_24dp, mPause, CONTROL_TYPE_PAUSE, REQUEST_PAUSE);
                }
                ...
                public void onMovieStopped() {
                    ...
                    updatePictureInPictureActions(
                            R.drawable.view_play_arrow_24dp, mPlay, CONTROL_TYPE_PLAY, REQUEST_PLAY);
                }
    ...
    void updatePictureInPictureActions(
        ...
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(PipActivity.this, R.drawable.view_info_24dp),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_activity_pip);
