 ...
 */
class TaskAdapter(private val mContext: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var mData: ArrayList<Task>? = null
    private var onItemClick: TaskAdapter.OnItemClick? = null
    private var onItemLongClick: OnItemLongClick? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val inflate = LayoutInflater.from(mContext).inflate(R.layout.item_manager_task, null)
        return Holder(inflate)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val viewHolder = holder as TaskAdapter.Holder
        ...
        viewHolder.tv_group.text = task.groupName
        if (onItemClick != null) {
    ...
    internal inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tv_group: TextView = itemView.findViewById(R.id.tv_group)
